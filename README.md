...
Statut actuel : détection des violations de couches et des cycles de dépendances pour TypeScript (via dependency-cruiser). Pas encore de support Kotlin, ni de rapport HTML.
